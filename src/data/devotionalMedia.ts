...
export const devotionalMedia: DevotionalMediaItem[] = [
  ...
  {
    id: 'shiv-bhajan-youtube-6MPtcqPuQx0',
    slug: 'shiv-bhajan-6MPtcqPuQx0',
    title: 'Har Har Mahadev Bhajan (Video)',
    artist: 'Devotional',
    type: 'video',
    category: 'Bhajan',
    src: '',
    thumbnail: defaultThumb,
    duration: '00:00',
    description: 'Devotional Shiv Bhajan — Har Har Mahadev.',
    lyricsHindi: 'हर हर महादेव।',
    transliteration: 'Har Har Mahadev',
    meaning: 'Glory to Mahadev, the great Lord Shiva.',
    tags: ['Video', 'Bhajan', 'YouTube', 'Mahadev'],
    youtubeId: '6MPtcqPuQx0',
  ...
  {
    id: 'mahadev-divya-bhakti',
    slug: 'mahadev-divya-bhakti',
    ...
    lyricsHindi: 'महादेव की दिव्य भक्ति।',
    transliteration: 'Mahadev Ki Divya Bhakti',
    meaning: 'Divine devotion to Mahadev — an offering of love and surrender to Lord Shiva.',
    tags: ['Video', 'Bhajan', 'YouTube', 'Mahadev', 'Featured', 'Divya', 'Spiritual'],
    youtubeId: 'b4c1UUqTU0Y',
    releaseDate: '2026-05-09',
    popularity: 92,
    allowDownload: false,
  },
  {
    id: 'bum-bum-mahakaal-anthem',
    slug: 'bum-bum-mahakaal-anthem',
    ...
    thumbnail: defaultThumb,
    duration: '03:02',
    description: 'Powerful Shiv Anthem invoking Mahakaal energy.',
    lyricsHindi: 'बम बम महाकाल।',
    transliteration: 'Bum Bum Mahakaal',
    meaning: 'A powerful anthem invoking the cosmic energy of Mahakaal, the destroyer form of Lord Shiva.',
    tags: ['Video', 'Bhajan', 'YouTube', 'Mahakaal', 'Anthem', 'Mahadev', 'Featured'],
    youtubeId: 'msSY1Od4WrE',
    releaseDate: '2026-05-09',
    popularity: 90,
    allowDownload: false,
  },
  {
    id: 'rudra-jagran-shiv-bhajan',
    slug: 'rudra-jagran-shiv-bhajan',
    ...
    thumbnail: defaultThumb,
    duration: '00:00',
    description: 'Powerful Rudra Jagran bhajan invoking Mahadev energy.',
    lyricsHindi: 'ॐ नमः शिवाय।',
    transliteration: 'Om Namah Shivaya',
    meaning: 'I bow to Lord Shiva, the auspicious inner Self.',
    tags: ['Video', 'Bhajan', 'YouTube', 'Rudra', 'Jagran'],
    youtubeId: 'JGnaoO8uqWI',
